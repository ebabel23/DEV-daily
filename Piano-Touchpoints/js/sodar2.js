...
*/
  ...
  function da(a) {
    var b =
      "undefined" != typeof r.Symbol &&
      w(r.Symbol, "iterator") &&
      a[w(r.Symbol, "iterator")];
    return b
      ? b.call(a)
      : {
          next: aa(a),
  ...
  var ea =
    ...
    y;
  if (p && "function" == typeof Object.setPrototypeOf)
  ...
  x(
    ...
    function (a) {
      ...
      b.prototype.S = function () {
        ...
        "function" === typeof e
          ? (e = new e("unhandledrejection", {
              cancelable: !0,
            }))
          : "function" === typeof f
          ? (e = new f("unhandledrejection", {
              cancelable: !0,
            }))
          : ((e = n.document.createEvent("CustomEvent")),
      ...
      b.race = function (e) {
        return new b(function (f, k) {
          for (var m = da(e), q = m.next(); !q.done; q = m.next())
            d(q.value).B(f, k);
        });
      };
      b.all = function (e) {
        ...
        : function (b, c, d) {
            ...
            var g = [],
              h =
                "undefined" != typeof r.Symbol &&
                w(r.Symbol, "iterator") &&
                b[w(r.Symbol, "iterator")];
            if ("function" == typeof h) {
              b = h.call(b);
              for (var e = 0; !(h = b.next()).done; )
                g.push(c.call(d, h.value, e++));
            } else
  ...
  function M(a) {
    return a instanceof K && a.constructor === K && a.g === na
      ? a.h
      : "type_error:Const";
  }
  var na = {},
  ...
  function pa(a) {
    return a instanceof O && a.constructor === O
      ? a.g
...
*/
  ...
  function ua(a, b) {
    ...
    return new r.Promise(function (d, g) {
      function h() {
        ...
        e.onload = null;
        e.onerror = null;
        null === (f = e.parentElement) || void 0 === f
          ? void 0
          : f.removeChild(e);
      }
  ...
  function U(a, b, c) {
    ...
    this.m = void 0 === c ? 0 : c;
    this.i = qa(
      new K(L, "https://pagead2.googlesyndication.com/bg/%{basename}.js"),
      {
  ...
  function Ea() {
    ...
    if (a && 0 < a.length && (a = a.shift()))
      return void 0 === a._rc_
        ? {
            context: Ca(a._ctx_),
            v: a._bgv_,
            u: a._bgp_,
  ...
  function Na() {
    this.url =
      "https://pagead2.googlesyndication.com/pagead/gen_204?id=sodar2&v=225";
  }
  function W(a, b, c) {
  ...
  function X(a, b, c) {
    ...
    (!1 !== c && g) ||
      (d.url =
        "https://pagead2.googlesyndication.com/pagead/sodar?id=sodar2&v=225");
    W(d, "t", a);
  ...
  function Ua(a, b) {
    function c(h) {
      h &&
        null !== h.data &&
        "https://www.google.com" === h.origin &&
        null != h.source &&
        h.source === b.contentWindow &&
        ((a.i = "id=sodar2&v=225"),
        a.g &&
          ((a.i += "&li=" + encodeURIComponent(a.g.F.toString())),
          (a.i +=
            "&" +
            ("cr" === a.g.context ? "bgai" : "jk") +
            "=" +
            encodeURIComponent(a.g.D.toString())),
  ...
  function Wa(a) {
    return H(function (b) {
      return E(
        b,
        w(r.Promise, "allSettled").call(r.Promise, [Sa(a), Va(a)]),
        0
      );
    });
  }
  function Ra(a) {
    return "tpc.googlesyndication.com" === window.location.host ||
      "int" === a.g.G
      ? !1
      : !0;
  }
