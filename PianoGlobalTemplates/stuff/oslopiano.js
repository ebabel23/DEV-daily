var fdpOslo = function() {
    ...
    var e = {
        ...
        updateAjaxUrl: "https://edu.abendblatt.de/?widgetid=205159525&view=login_update&art=213926893&sec=33981",
        updateRidAjaxUrl: "https://edu.abendblatt.de/?widgetid=205159525&view=login_update_rid&art=213926893&sec=33981"
    }
      , f = function() {
        return "localhost" === window.location.hostname ? "//uat.abendblatt.de" : window.location.origin
    }
      ...
      , m = function() {
        ...
        return "uat" === e || "edu" === e ? "https://sandbox.tinypass.com" : "https://buy.tinypass.com"
    }
    ...
    function l() {
        ...
        if (null !== o && null !== a) {
            var r;
            r = -1 !== n.host.indexOf("uat") || -1 !== n.host.indexOf("dev") || -1 !== n.host.indexOf("edu") ? "dev" : "prod";
            var s = encodeURIComponent(n)
              , i = encodeURIComponent(o)
              , d = encodeURIComponent(a);
            fetch("https://" + r + ".s.rtd.aws.funkedigital.de/s/s?url=" + s + "&sso=" + i + "&ssouie=" + d).then(function(e) {
                return e.json()
            }).then(function(e) {})
        }
        e && 0 < e.length ? jQuery.ajax(p({}, {
            type: "POST",
        ...
        }).fail(function(e) {}) : window.Cookies.set("pcst_rid", window.fdpConfig.rid, {
            expires: 28,
            path: "/"
        }),
    ...
    function v() {
        return window.fdpOslo.customEventsHook.trigger("onLoginRequired"),
        !1
    }
    function k() {
    ...
    var j = function() {
        ...
        return o(e.prototype, [{
            ...
            value: function(o, a) {
                var n = this;
                this.actions[o] && (a ? this.actions[o].forEach(function(e, t) {
    ...
    function P(e, t, o, a, n) {
        ...
        r.length ? r[0].contentWindow.postMessage({
            piano: {
                success: t,
                message: o,
                object: a
    ...
    function x(n) {
        ...
        new Promise(function(t, o) {
            ...
            new Promise(function(t) {
                if (a.evolverCookie) {
                    ...
                    e[e.length - 1].onload = function() {
                        ...
                        var e = S();
                        e.done(function(e) {
                            e.success && 1 === e.code && tp.push(["setCustomVariable", "userStateIsPremium", !0])
                        }),
                        e.always(function(e) {
                            t(e)
                        })
            ...
            new Promise(function(e, t) {
                if (l) {
                    var o, a, n;
                    jQuery(".header .header-top-button--login").addClass("state-loading"),
                    window.Cookies.set("pclld", (a = (o = new Date).getDate(),
                    n = o.getMonth() + 1,
                    ("" + o.getFullYear() + (n < 10 ? "0" + n : n) + (a < 10 ? "0" + a : a)).toString()), {
                        expires: 28,
                        path: "/"
                    });
                    var r = "".concat(u.updateAjaxUrl, "&pcsi=").concat(c.userId, "&rst=").concat(u.pc)
                      , s = "".concat(u.updateAjaxUrl, "&pcsi=").concat(c.userId, "&rst=").concat(u.ep)
                      , i = "".concat(u.updateRidAjaxUrl, "&pcsi=").concat(c.userId, "&rst=").concat(u.rid)
                      , d = "localhost" === document.location.hostname ? {
                        type: "POST",
                        xhrFields: {
                            withCredentials: !0
                        },
                        beforeSend: function(e) {
                            e.setRequestHeader("Authorization", "Basic ".concat(window.btoa("hao:Abendblatt!")))
                        }
                    } : {};
                    void 0 !== u.pc || void 0 !== u.ep || void 0 !== u.rid ? jQuery.when(jQuery.ajax(p({
                        url: r
                    }, d)).done(function(e) {
                    ...
                    e("Coming from registration")
            }
            ))]).then(function() {
                P(n.tpParams.iframeId, !0, "loader", {
                    loading: !0
                }),
                jQuery(".header .header-top-button--login").removeClass("state-loading"),
                "" === window.Cookies.get("pcst_pc") || void 0 === window.Cookies.get("pcst_pc") ? jQuery.ajax({
                    type: "POST",
                    xhrFields: {
                        withCredentials: !0
                    },
                    ...
                    window.fdpOslo.customEventsHook.trigger("paywall-signin", e),
                    window.location.reload()
                }).fail(function(e) {}) : window.location.reload()
            }).catch(function(e) {})
        }).catch(function(e) {})
    }
    var I = new j;
    ...
    I.on("paywall-password-forgotten", function(a) {
        ...
        new Promise(function(t, o) {
            ...
            tp.push(["setCustomVariable", "tp_password_reset_success", e.success]),
    ...
    I.on("default", function(e) {
        ...
        t.templateId && 0 < t.templateId.length && (t.offerId && 0 < t.offerId.length ? D.showOffer(D.showTemplateConfig(t)) : D.showTemplate(D.showTemplateConfig(t))),
    ...
    var D = {
        ...
        showTemplateByTagVar: function(e) {
            ...
            Object.keys(tp.customVariables).forEach(function(e) {
                (e.match(/tp_/) || "default" === e) && tp.push(["setCustomVariable", e, !1])
            }),
        ...
        showTemplateConfig: function(e) {
            var t = e.templateId
              ...
              , r = e.displayMode;
            if (!t && !a)
                throw new Error("There is no template ID defined");
            return {
        ...
        setupFdpmodal: function() {
            var t = this
              ...
              , o = function(e) {
                ...
                n = o.remodalTrigger,
                r = jQuery(a).remodal((t = n).dataset.remodalOptions ? t.dataset.remodalOptions.replace(/\s/g, "").split(",").reduce(function(e, t) {
                    var o = t.split(":");
                    return e[o[0]] = "hashTracking" === o[0] ? "true" === o[1] : o[1],
                    e
                }, {}) : ""),
            ...
            jQuery(document).on("click", ".js-tploader", function(e) {
                "fdpmodal" === e.currentTarget.dataset.displaymode ? o(e.currentTarget) : i(e.currentTarget)
            }),
            ...
            jQuery(document).on("opening", ".remodal", function() {
                window.setTimeout(jQuery.remodal.lookup.forEach(function(e) {
    ...
    return jQuery(function() {
        ...
        window.tp.push(["init", function() {
            new RegExp("\\b".concat("login=true", "\\b")).test(window.location.search) && !tp.user.isUserValid() && e.trigger("click")
        }
        ])
    }),
    window.tp.push(["addHandler", "showOffer", function() {
        window.tp.user.isUserValid() && N.checkUserStatus().done(function(e) {
            e.success && 1 === e.code && tp.push(["setCustomVariable", "userStateIsPremium", !0])
        })
    }
    ]),
    new function e() {
        ...
        function() {
            if (!window.location.origin) {
                var e = window.location.port ? ":".concat(window.location.port) : "";
                window.location.origin = "".concat(window.location.protocol, "//").concat(window.location.hostname).concat(e)
            }
            ...
            window.addEventListener("message", function(e) {
                if (e.origin === m() && e.data.fdp && "FDP_PASSWORD_CHANGE" === e.data.fdp.message && e.data.fdp.data.isChangingPassword) {
                    var t = []
                      , o = e.data.fdp.data
                      , a = o.currentPassword
                      , n = o.newPassword
                    ...
                    0 < t.length)
                        ...
                        l = [],
                        (d = c,
                        jQuery.ajax(d).fail(function(e) {})).done(function(e) {
                            P(s, !0, "FDP_NOTIFICATION__PASS_CHANGE_SUCCESS", e)
                        }).fail(function(e) {
                            10002 === e.responseJSON.code && l.push({
